...
class ListSubmissionAdminResponse extends BaseResponse {
  final ListDataResponse? data;

  ListSubmissionAdminResponse(
      {required bool status, required String message, this.data})
      : super(status: status, message: message);

  factory ListSubmissionAdminResponse.fromJson(Map<String, dynamic> json) {
...
class ListDataResponse {
  ...
  final int? prevPage;
  final int? limit;
  final List<SubmissionAdminModel> result;
  ...
  factory ListDataResponse.fromJson(Map<String, dynamic> json) {
    ...
    List<SubmissionAdminModel> dataList =
        list.map((i) => SubmissionAdminModel.fromJson(i)).toList();
